...
function Enquire() {
  return (
   <>
   <Navbar/>
   <section className="bg-gray-800 text-gray-100 px-8  py-16 pb-20">
      <div className="text-center w-full">
      
<h2 className='text-3xl font-bold uppercase'>Recording Happiness in Reel</h2>
       
      </div>
      <div
        className="max-w-screen-xl mt-12 px-8 grid gap-8  grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">Lets Capture Your Moments</h2>
            <div className="text-gray-700 mt-8">
              Hate forms? Send us an <span className="underline">email</span> instead.
            </div>
          </div>
          <div className="mt-8 text-center">
            <svg className="w-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="ae37f038-3a9e-4b82-ad68-fc94ba16af2a" data-name="Layer 1" viewBox="0 0 1096 574.74">
              <defs>
                ...
                <linearGradient id="a964f849-fa65-4178-8cc4-fb8fb10b3617" x1="462.91" y1="660.68" x2="462.91" y2="559.69" xlinkHref="#eb6c86d6-45fa-49e0-9a60-1b0612516196" />
        ...
        <div className="">
          ...
          <div className="mt-8  ">
            <button
              className="uppercase  text-sm font-bold tracking-wide   p-3 rounded-lg w-full focus:outline-none focus:shadow-outline  enquire_submit_btn ">
              Send Message
            </button>
          </div>
        </div>
